...
/*
batch updates are useful if the DOM updates are happening at a very high speed and only the intital and final updates matter in the end
as the updates in between are very fast to make it visible to naked eye or impractical to update the DOM so fast.
*/
window.setInterval(() => {
    let todos = [];
